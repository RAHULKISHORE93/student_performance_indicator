...
class ModelTrainerConfig:
    trained_model_file_path = os.path.join("artifacts","model.pkl") # "model.pkl" is the file name it saved
...
class ModelTrainer:
    ...
    def initiate_mode_trainer(self,train_array,test_array):
        try:
            ...
            best_model_score = list(model_report.keys())[list(model_report.values()).index(best_model_score)]
